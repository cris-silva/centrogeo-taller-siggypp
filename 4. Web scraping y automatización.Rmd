...
Para comenzar a enviar instrucciones a Selenium, debemos definir qué explorador vamos a manejar. Usa la función `rsDriver` y especifica el parámetro `browser = "firefox"` para indicar a Selenium que use Firefox. Guarda la instancia del servidor en la variable `servidor_selenium`:
